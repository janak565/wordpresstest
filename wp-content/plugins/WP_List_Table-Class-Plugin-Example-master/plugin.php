...
Description: Demo on Customer List
Version: 1.0
...
define('MY_INSTAGRAM_PLUGIN_PATH', WP_PLUGIN_DIR . '/WP_List_Table-Class-Plugin-Example-master/');
...
class SP_Plugin {
	...
	public function __construct() {
		...
		//register_activation_hook(__FILE__, [ __CLASS__, 'set_screen']);
		
		register_deactivation_hook( __FILE__, [ $this, 'my_plugin_remove_database' ] );
...
class MyPlugin {
    ...
    public static  function init() {
		register_activation_hook(MY_INSTAGRAM_PLUGIN_PATH.'plugin.php', [__CLASS__, 'plugin_activate' ]);
